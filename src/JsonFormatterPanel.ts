...
export class JsonFormatterPanel {
    ...
    public static readonly viewType = "Json Formatter";
    ...
    public static createOrShow(extensionUri: vscode.Uri) {
        ...
        if (JsonFormatterPanel.currentPanel) {
            ...
            JsonFormatterPanel.currentPanel._update();
            return;
        }
    ...
    public static kill() {
        JsonFormatterPanel.currentPanel?.dispose();
    ...
    private _getHtmlForWebview(webview: vscode.Webview) {
        ...
        const scriptUri = webview.asWebviewUri(
            vscode.Uri.joinPath(this._extensionUri, "out", "compiled/JsonFormatter.js")
        );
        const styleMainUri = webview.asWebviewUri(
            vscode.Uri.joinPath(this._extensionUri, "out", "compiled/JsonFormatter.css")
        );
